...
import iconPlayCircle from '../../components/icons/music_play_circle.png';
import iconPause from '../../components/icons/music_pause.png';
import iconPauseCircle from '../../components/icons/music_pause_circle.png';
import iconStopCircle from '../../components/icons/music_stop_circle.png';
import iconNext from '../../components/icons/music_next.png';
import iconPrev from '../../components/icons/music_prev.png';
import iconVolume from '../../components/icons/icon_volume.png';
...
class AudioPlayer extends React.Component <PropsType, StateType> {
    ...
    switchTrack = (direction: string) => {
        ...
        if (
            currentTrackIndex === 0 && direction === "prev" ||
            currentTrackIndex === lastTrackIndex && direction === "next"
        ) {
            return;
        }

        const newIndex = direction === "prev" ? currentTrackIndex - 1 :
        ...
        return (
            <div className={styles.AudioPlayer}>
                ...
                <div className={styles.control_bar}>
                    ...
                    <div>
                        <IconButton size="small" onClick={() => this.switchTrack("prev")}>
